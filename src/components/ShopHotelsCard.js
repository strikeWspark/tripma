...
export const ShopHotelsCard = ({imageUrl,city,place,description,price}) => {
    return (

            <div className="w-[350px] shadow-xl border flex flex-col  my-4 rounded-lg hover:scale-105 duration-300">
                    <img className="w-[350px] h-[250px] rounded-lg"src={imageUrl} alt="icon" />
